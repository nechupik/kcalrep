      ...
      <DialogContent className="bg-card/95 backdrop-blur-sm border-border/50 max-w-[calc(100%-40px)] sm:max-w-md rounded-2xl p-6">
        ...
        <div className="space-y-4">
          ...
          <p className="text-xs text-muted-foreground">
            В отчёт войдут: время приёмов пищи, что съедено по дням, дневные итоги и дефицит калорий, BMR и настройки дефицита по дням, изменение веса и состава тела, активность и TDEE, активность и шаги (ручной ввод) — за выбранный период.
          </p>
        </div>
